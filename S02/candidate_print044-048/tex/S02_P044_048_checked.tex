...
% Checked against the scan (master PDF 133-137) on 2026-09-26: builds with LuaLaTeX,
% C01-C06 resolved, three readings corrected; see S02_P044_048_CHECK.md.
%
...
\newcommand{\SourceCrop}[6]{%
  ...
  % graphicx needs four space-separated trim values, so the two
  % measured lengths are expanded before it parses them.
  \edef\SourceCropOptions{page=#1,
    trim={#2bp \the\SourceBottomTrim\space\the\SourceRightTrim\space #3bp},
    clip}%
  \expandafter\includegraphics\expandafter[\SourceCropOptions,width=#6]{\MasterPDF}%
  \endgroup
}
...
has observationes manifesta ({\itshape b}).
...
\A{AB01-PDF0133-N03}
\NN{3}{Plato male $1^\circ58'$; {\addfontfeatures{LetterSpace=0.5} Ibn Yūnus}
(apud {\addfontfeatures{LetterSpace=0.5} Caussin}, \textit{Le livre de la grande table Hakémite},
in Notices et extraits des mss. de la Bibl. Nation., t. VII,
Paris 1804, p. 155) scribit: « al-Battānī aequationem totam
Solis calculavit, invenitque $1^\circ59'10''$ esse ».
{\addfontfeatures{LetterSpace=0.5} Halley} p. 917, et {\addfontfeatures{LetterSpace=0.5} Delambre}, \textit{Astr. moyen âge}, p. 36,
...
Arabicum \textit{al-mumaththal bi falak al-burūǵ}
...
\GR{ὁ ὁμόκεντρος τῷ διὰ μέσων τῶν ζωδίων κύκλος}
« circulus concentricus circulo per medium signorum
transeunti » (i. e. eclipticae) vocatur. In astronomia
Syriaca Barhebraei vertenda, {\addfontfeatures{LetterSpace=0.5} Nau} eum
\textit{intersphère de la similitude} appellat; {\addfontfeatures{LetterSpace=0.5} Golius},
in versione al-Farghānī, et {\addfontfeatures{LetterSpace=0.5} Sédillot}, in versione Ulugh Beg,
...
circiter esse ({\itshape d}). Sed ex partibus quarum linea EF
...
\begin{minipage}[t]{.53\textwidth}
  ...
  continebit ({\itshape e}). Sed ex partibus quarum EG 60
...
\A{AB01-PDF0135-N14}
\NN{14}{Plato $1^{p}4'54''$.}

\A{AB01-PDF0135-N15}
\NN{15}{Cod. IB (\AR{ى} I pro \AR{ن} N); Plato GB.
...
\begin{minipage}[t]{.51\textwidth}
  ...
  \centering
  \A{AB01-PDF0136-F01}
  % Source region: x0=65, y0=480, x1=298, y1=649.
  \SourceCrop{136}{65}{480}{298}{649}{\linewidth}
\end{minipage}
\hfill
...
idque, volente Deo, est sinus aequationis mediae ({\itshape g}).
...
aut mediae noctis\NM{8} ({\itshape a}).
